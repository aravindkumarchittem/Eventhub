...
// SQL query to fetch registered events for the current user
...
#searchInput:focus {
    ...
    background: rgba(35, 35, 35, 0.9); /* Darker semi-transparent background on focus */
}
...
.slides-container {
    ...
    justify-content: center;
    margin-top: 15px; /* Ensure content starts below fixed navbar */
}
...
.event-card {
    width: 450px;
    background: rgba(6, 6, 6, 0.8); /* Transparent background */
    padding: 2rem;
        ...
        <section id="events" class="events-section">
            <div class="slides-container">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<p style="text-align: center; margin-top: 20%;">No events registered.</p>';
                }
